...
This project is indexed by GitNexus as **MamMi** (1866 symbols, 4638 relationships, 146 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
