...
This project is indexed by GitNexus as **MamMi** (2484 symbols, 6026 relationships, 198 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
