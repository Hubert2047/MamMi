...
This project is indexed by GitNexus as **MamMi** (1481 symbols, 3759 relationships, 116 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
